package marcozagaria.u2_w2_d1.services;

import marcozagaria.u2_w2_d1.entities.BlogPost;
import marcozagaria.u2_w2_d1.exeption.NotFoundException;
import marcozagaria.u2_w2_d1.payloads.BlogPostPayload;
...
public class BlogPostService {
    ...
    public BlogPost saveBlogPost(BlogPostPayload body) {
        ...
        newBlogPost.setId(rndm.nextInt(1000, 10000));
